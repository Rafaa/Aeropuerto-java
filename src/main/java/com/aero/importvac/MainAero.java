...
public class MainAero {
    ...
    public static void main(String argv[]) {
        ...
        try {
            ...
            File fXmlFile = new File("/home/rafaa/Desktop/airport-list.html");
    ...
    public void parseVac() {
        try {
            ...
            /*for(int i = 500; i <= 500; i++) {
                airportEntity = new AirportTMPEntity();

            //    airportEntity.setAirportId(i);
                airportEntity.setCodeOaci("XXXY");
                airportEntity.setAllInformationP1("Administrator");
                airportEntity.setAllInformationP2(new Date().toString());

                sessionObj.save(airportEntity);
            }
    ...
    private static void doTheJob(NodeList nList) throws IOException {
        for (int temp = 0; temp < nList.getLength(); temp++) {
            ...
            if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                ...
                if(f.exists() && !f.isDirectory()) {
                    ...
                    URL website = new URL("https://www.sia.aviation-civile.gouv.fr/dvd/eAIP_24_MAY_2018/Atlas-VAC/PDF_AIPparSSection/VAC/AD/AD-2." + eElement.getAttribute("value") + ".pdf");
                ...
                try {
                    ...
                    String userString="INSERT INTO Airports (code_oaci, all_information_p1, all_information_p2, all_information_p3, all_information_p4" +
